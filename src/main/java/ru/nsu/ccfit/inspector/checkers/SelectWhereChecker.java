 ...
 */
public class SelectWhereChecker implements Checker {
    private Parser parser;
    private ParseTree tree;

    public SelectWhereChecker(Parser parser, ParseTree tree) {
        this.parser = parser;
        this.tree = tree;
    }
    ...
    public void check(List<CodeSmell> codeSmells) {
        String xpath = "//select_statement";
        String treePattern = "<SELECT> <search_condition> <sql_clause>";
